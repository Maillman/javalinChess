...
public class ChessGameTests extends EqualsTestingUtility<ChessGame> {
    ...
    protected Map.Entry<String, ChessGame> buildOriginal() {
        return Map.entry("Chess Game with Default board", new ChessGame());
    }
    ...
    protected Map<String, ChessGame> buildAllDifferent() {
        ...
        try {
            ...
            differentGames.put("Chess Game with Different team turn", game1);
            ...
            game2.makeMove(new ChessMove(
                    ...
                    null));
            differentGames.put("Chess Game with Moved pawn", game2);
            ...
            game3.makeMove(new ChessMove(
                    ...
                    null));
            differentGames.put("Chess Game with Moved knight", game3);
            ...
            game4.setBoard(TestUtilities.loadBoard("""
                    ...
                    | | | |R| | | | |
                    """));
            differentGames.put("Chess Game with Preset board", game4);
